...
DOC_MODEL_PATHS = {
    "Aadhar Card": "/home/stark/Documents/verifydoctesting/models/aadhaar.pt",
    "PAN Card": "/home/stark/Documents/verifydoctesting/models/pan_best.pt",
    "Handicap smart card": "/home/stark/Documents/verifydoctesting/models/handicap_smart_card.pt",
    "Birth Certificate": "/home/stark/Documents/verifydoctesting/models/Birth_certificatebest.pt",
    "Bonafide Certificate": None,
    "Caste certificate": "/home/stark/Documents/verifydoctesting/models/caste_certificate.pt",
    "Current Month Salary Slip": "/home/stark/Documents/verifydoctesting/models/salaryslipbest.pt",
    "Passport and VISA": "/home/stark/Documents/verifydoctesting/models/passport.pt",
    "Marksheet": None,
    "Transgender Certificate": "/home/stark/Documents/verifydoctesting/models/trans_best.pt"
}
...
def generate_key():
    ...
    return jsonify({"api_key": api_key, "message": "New API key generated"})
    ...
    for email, key_data in api_keys.items():
        if key_data['key'] == api_key:
            return jsonify({
                "valid": True, 
                "email": email, 
                "company": key_data.get('company', 'Unknown')
            })
